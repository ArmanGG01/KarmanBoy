...
┠➣ *ɢʀᴏᴜᴘꜱ ᐉ* `{}`
┗━━━━━━━━━━━━━━━━━━━━━━━
*✮ ᴀᴋᴜ ᴅɪʙᴜᴀᴛ ᴜɴᴛᴜᴋ ᴍᴇɴɢᴇʟᴏʟᴀ ᴅᴀɴ*
*ᴍᴇᴍᴜᴛᴀʀ ᴍᴜꜱɪᴋ ᴅɪɢʀᴜᴘ ᴅᴇɴɢᴀɴ *
*ʙᴇʀʙᴀɢᴀɪ ꜰɪᴛᴜʀ. ✮*
━━━━━━━━━━━━━━━━━━━━━━━━
"""
...
buttons = [
    [
        InlineKeyboardButton(text="ʙᴀɴᴛᴜᴀɴ", callback_data="obrolansuar"
       ),
       InlineKeyboardButton(
            text="sᴜᴘᴘᴏʀᴛ", url="https://t.me/obrolansiar"
        ),
    ],
    [
        InlineKeyboardButton(
            text="ᴊᴀsᴀ ʙᴏᴛ", callback_data="PakkPoll"
        ),
        InlineKeyboardButton(
            text="ᴅᴏɴᴀsɪ 💢", callback_data="Karman"
       ),
     ],
     [
        InlineKeyboardButton(
            text="ᴛᴀᴍʙᴀʜᴋᴀɴ ᴀᴋᴜ ᴅɪʜᴀᴛɪᴍᴜ 💢", url="t.me/KarmanMusicBot?startgroup=true"
        ),
     ],
]
...
KYNAN_IMG = "https://telegra.ph/file/3f4c55755b365077bfc05.jpg"

DONATE_STRING = """Jika ingin berdonasi agar bot ini tetap hidup, kamu bisa contact @PakkPoll."""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(f"Kynan.modules.{module_name}")
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text(
            f"<b>ʙᴀɴᴛɪɴɢ ᴅᴇᴅᴇ ᴅᴏɴɢ ʙᴀɴɢ</b>\n<b>❤️ :</b> <code>{uptime}</code>",
    ...
    if query.data == "kynan_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ᴘᴇʀɪɴᴛᴀʜ ᴀᴅᴍɪɴ", callback_data="Karman_admin"),
                    InlineKeyboardButton(text="ᴘᴇʀɪɴᴛᴀʜ ʙᴏᴛ", callback_data="Karman_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="ᴘᴇʀɪɴᴛᴀʜ ᴘʟᴀʏ", callback_data="source_"),
                    InlineKeyboardButton(text="ᴘᴇʀɪɴᴛᴀʜ ᴇxsᴛʀᴀ", callback_data="Karman_credit"),
                 ],
                 [
                    InlineKeyboardButton(text="⩹", callback_data="Karman_support"),
                 ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="⩹", callback_data="Karman_")]]
            ),
        )
    elif query.data == "Karman_jasa":
        query.message.edit_text(
            ...
            "\n      └ sɪsᴛᴇᴍ ᴛᴇʀɪᴍᴀ ᴊᴀᴅɪ"
            "\n\n   ᴄᴀᴛᴀᴛᴀɴ:"
            "\n      1. ᴀᴘᴀʙɪʟᴀ ʙᴏᴛ ʏᴀɴɢ ᴀɴᴅᴀ ɪɴɢɪɴᴋᴀɴ ᴛɪᴅᴀᴋ ᴀᴅᴀ ᴅɪᴀᴛᴀs, sɪʟᴀᴋᴀɴ ᴘᴍ ᴋᴀʀᴍᴀɴ"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                    InlineKeyboardButton(text="️ᴀʀᴍᴀɴ", url="https://t.me/PakkPoll"),
                    InlineKeyboardButton(text="⩹", callback_data="Karman_back"),
                  ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="ᴍᴜsɪᴄ ♬", callback_data="Karman_"),
